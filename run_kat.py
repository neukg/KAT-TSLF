...
from kat.data import KATDataset, KATDataCollator
from kat.modeling import BartForConditionalGeneration
...
def train(args, train_dataset, model: BartForConditionalGeneration, tokenizer):
    ...
    train_dataloader = DataLoader(train_dataset, sampler=train_sampler, batch_size=args.train_batch_size, collate_fn=KATDataCollator(tokenizer, args))
